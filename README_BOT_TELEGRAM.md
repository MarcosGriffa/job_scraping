# Observatorio IT Junior — el bot de Telegram (versión original)
...
> **Esta es la versión original del proyecto**, de cuando corría por consola
> y se manejaba desde Telegram. Se conserva como registro de cómo arrancó.
>
> El proyecto evolucionó a **EmpatÍA | NextStep** (ver el
> [README principal](README.md)): una web con cuentas reales, matching para
> cualquier rubro y base de datos en la nube. El código del bot sigue en el
> repo (`bot_listener.py`, `bot_daily.py`) y funciona, pero el desarrollo
> activo está en la versión web.
