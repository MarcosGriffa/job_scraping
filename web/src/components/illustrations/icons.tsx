...
// A diferencia del resto (trazo monocromo, hereda color del contexto),
// el logo de Google va a color real: es la convención esperada en un botón
// de "Continuar con Google" — un ícono de una sola línea ahí se ve raro y
// es menos reconocible/confiable para quien lo usa.
export function IconGoogle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" {...props}>
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.4l6.6 5.6C41.4 36.4 44 30.7 44 24c0-1.3-.1-2.7-.4-3.5z"
      />
    </svg>
  );
}
